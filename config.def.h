...
static const char *scratchpadcmd[] = { "alacritty", "-t", scratchpadname, "-d", "60","17",NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_w,      spawn,          SHCMD("firefox -new-window https://web.whatsapp.com/") },
	...
	{ ControlMask|ShiftMask,        XK_comma,  tagswapmon,     {.i = +1 } },
	{ ControlMask|ShiftMask,        XK_period, tagswapmon,     {.i = -1 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
